...
class GlobalRule(Base, TimestampMixin):
    ...
    Examples:
    - "Acme Mail requires at least one module to be installed."
    - "If only module 'Files' is installed, Acme Mail will work."
    """
    ...
    # Optional category for grouping (e.g., "Acme Mail", "General")
