"""
Acme Mail WebSocket XMPP Client
==============================

Custom XMPP client using WebSocket transport (RFC 7395) for Acme Mail chat history.
"""
...
class Acme MailWebSocketXMPP:
    """
    WebSocket XMPP client for Acme Mail using RFC 7395 framing.
    """
    ...
    async def get_xmpp_token(self) -> Optional[str]:
        ...
        try:
            ...
            async with httpx.AsyncClient(
                ...
                # logger.info(f"Warming up session at https://{domain}/acme-mail/")
                # await client.get(f"https://{domain}/acme-mail/")
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # Browser sends to="acme-mail", not the domain name
            open_stanza = f'''<open xmlns="{NS_FRAMING}" to="acme-mail" version="1.0"/>'''
    ...
    async def _authenticate(self) -> bool:
        ...
        try:
            ...
            if "success" in response.lower():
                ...
                # Browser sends to="acme-mail" here too
                await self.ws.send(f'<open xmlns="{NS_FRAMING}" to="acme-mail" version="1.0"/>')
    ...
    async def get_room_history(
        ...
        try:
            # Use acme-mail domain for MUC Light as observed in browser
            room_jid = f"{room_id}@muclight.acme-mail"
            ...
            ping_stanza = f"<iq type='get' to='acme-mail' id='{ping_id}'><ping xmlns='urn:xmpp:ping'/></iq>"
...
async def get_chat_history(
    ...
    """
    client = Acme MailWebSocketXMPP(host, auth_token, email, cookies, xmpp_uuid)
