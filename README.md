...
- **Shared Corpus Architecture**: The `default` tenant acts as the enterprise knowledge base. Tenants inherit shared Carbonio content without duplication, while tenant-local data remains fully isolated.
